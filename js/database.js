...
function DBUtils()
{
	...
	// Define the K-Spec database tables and versions
	...
	*/	
	this.createInspections = function(table_number)
	{
		...
		var sql = "CREATE TABLE IF NOT EXISTS inspections  (" +
                ...
                "'omission_note_1' VARCHAR NULL, " +
                "'omission_note_2' VARCHAR NULL, " +
                "'omission_note_3' VARCHAR NULL, " +
                "'omission_note_4' VARCHAR NULL, " +
                "'omission_note_5' VARCHAR NULL, " +
                "'omission_note_6' VARCHAR NULL, " +
                "'omission_note_7' VARCHAR NULL, " +
                "'omission_note_8' VARCHAR NULL, " +
                "'omission_note_9' VARCHAR NULL, " +
                "'omission_note_10' VARCHAR NULL, " +
                "'omission_note_11' VARCHAR NULL, " +
                "'omission_note_12' VARCHAR NULL, " +
                "'omission_note_13' VARCHAR NULL, " +
                "'omission_note_14' VARCHAR NULL, " +
                "'omission_note_15' VARCHAR NULL, " +
                "'omission_note_16' VARCHAR NULL, " +
                "'omission_note_17' VARCHAR NULL, " +
                "'omission_note_18' VARCHAR NULL, " +
                "'omission_note_19' VARCHAR NULL, " +
                "'omission_note_20' VARCHAR NULL, " +
                "'omission_note_21' VARCHAR NULL, " +
                "'omission_note_22' VARCHAR NULL, " +
                "'omission_note_23' VARCHAR NULL, " +
                "'omission_note_24' VARCHAR NULL, " +
                "'omission_note_25' VARCHAR NULL, " +
                "'omission_note_26' VARCHAR NULL, " +
                "'omission_note_27' VARCHAR NULL, " +
                "'omission_note_28' VARCHAR NULL, " +
                "'omission_note_29' VARCHAR NULL, " +
                "'omission_note_30' VARCHAR NULL, " +
                "'omission_note_31' VARCHAR NULL, " +
                "'omission_note_32' VARCHAR NULL, " +
                "'omission_note_33' VARCHAR NULL, " +
                "'omission_note_34' VARCHAR NULL, " +
                "'created_by' INTEGER NOT NULL, " +
				"'deleted' INTEGER NOT NULL DEFAULT 0 , " +
